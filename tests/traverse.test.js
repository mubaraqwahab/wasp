Deno.test("should travel to all the nodes in the tree and reverse the math", () => {
  const ast = {
    type: "CallExpression",
    name: "add",
    arguments: [
...
Deno.test("should travel to all the nodes in the tree and double all of the numbers", () => {
  const ast = {
    type: "CallExpression",
    name: "add",
    arguments: [
